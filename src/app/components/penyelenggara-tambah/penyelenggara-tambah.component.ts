...
const CREATE_ORGANIZER_API =
  'http://organizer-service-website-lelang-bca-dev.apps.ocpdev.dti.co.id/create';
...
export class PenyelenggaraTambahComponent implements OnInit {
  ...
  createOrganizer() {
    if (this.createOrganizerForm.valid) {
      this.http
        .post<any>(
          CREATE_ORGANIZER_API,
          this.createOrganizerForm.value,
